#Authors: Roberto Goncalves Pacheco and Pedro Cruz
#Universidade do Estado do Rio de Janeiro and Universidade Federal do Rio de Janeiro
#Departamento de Eletronica e Telecomunicacoes and Grupo de Teleinformatica e Automacao
#Project: Sensing Bus
...
MEASUREMENTS_URL = <insertion_url> #Endpoint of insertion api on a cloud node
COMPRESSION_LEVEL = 9
...
def cloud_client(payload):
    ...
    payload = zlib.compress(json.dumps(payload).encode('utf-8').encode('zlib_codec'), 
                COMPRESSION_LEVEL)
